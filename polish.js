...
for(const section of document.querySelectorAll('.hero,.region,.story-opening,.transmission')){
 let x=0,y=0,tx=0,ty=0,frame=0,visible=true;
 const tail=section.matches('.transmission');
 const driftWidth=section.matches('.hero')?4:tail?10:14,driftHeight=section.matches('.hero')?3:tail?7:10;
